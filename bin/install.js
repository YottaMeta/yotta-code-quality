#!/usr/bin/env node
/**
 * @yottameta/yotta-code-quality cross-platform installer.
 *
 * Usage:
 *   npx -y @yottameta/yotta-code-quality --agent <name>
 *   npx -y @yottameta/yotta-code-quality --dir <path>
 *   npx -y @yottameta/yotta-code-quality -g
 *   npx -y @yottameta/yotta-code-quality
 *   npx -y @yottameta/yotta-code-quality --list
 */
'use strict';
...
function usage() {
  console.log('yotta-code-quality installer');
  console.log('');
  console.log('Usage:');
  console.log('  npx -y @yottameta/yotta-code-quality --agent <name>  Install to an agent default directory');
  console.log('  npx -y @yottameta/yotta-code-quality --dir <path>     Install to a custom directory');
  console.log('  npx -y @yottameta/yotta-code-quality -g               Install to all known agent directories');
  console.log('  npx -y @yottameta/yotta-code-quality                  Auto-detect project-level directories');
  console.log('  npx -y @yottameta/yotta-code-quality --list           List supported agent directories');
  console.log('');
  console.log('Options:');
